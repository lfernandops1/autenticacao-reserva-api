...
class HistoricoAutenticacaoServiceImplTest {
    ...
    @InjectMocks
    private HistoricoAutenticacaoServiceImpl service;

    @Mock
    private HistoricoAutenticacaoRepository historicoRepository;

    @Mock
    private AutenticacaoCloneMapper cloneMapper;

    @Mock
    private AutenticacaoComparadorService comparadorService;
